...
public class ImportatoreBatch {
     ...
     * 
     * @param parti l'array generato dallo split contenente tokenizzati i parametri
     *              del comando
     */
    private void creaCategoriaCmd(String[] parti) {
        ...
        try {
            gestoreCategorie.creaCategoria(nome, descr, padre);
    ...
    private void aggiungiCampoCmd(String[] parti) {
        ...
        try {
            cat.creaCampo(nomeCampo, descr, obbligatorio, tipo);
     ...
     * effettuando anche una successiva valutazione di Verifica Validità per
     * memorizzarla in pool.
     * 
    ...
    private void creaPropostaCmd(String[] parti) {
        ...
        Proposta p = gestoreProposte.getBacheca().creaProposta(cat);
     ...
     * 
     * @param parti i parametri estratti, di cui interessa essenzialmente la PK
     *              Titolo
     */
